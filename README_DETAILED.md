...
The product screenshots above are enough for the core README. For a stronger submission package, add these optional proof screenshots when available:

| Screenshot | Suggested File | Why It Helps |
|---|---|---|
| GCP Cloud Run services | `docs/Screenshots/GCP Cloud Run Services.png` | Proves frontend and backend are deployed on GCP |
| GCP Cloud Logging | `docs/Screenshots/GCP Cloud Logging.png` | Supports the auditability and operations story |
| LangSmith trace | `docs/Screenshots/LangSmith Trace.png` | Shows graph-level agent observability |
